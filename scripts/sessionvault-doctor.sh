...
RUNTIME_PLUGIN="$ROOT_HERMES_HOME/plugins/sessionvault"
LEGACY_RUNTIME_PLUGIN="$ROOT_HERMES_HOME/hermes-agent/plugins/memory/sessionvault"
...
echo "Legacy runtime (ignored): $LEGACY_RUNTIME_PLUGIN"
